...
console.log('Sincronizando arquivos JSON de dep-estadual a partir do MySQL...');
const sql = "SELECT slug, uf, patrimonio_total, receitas_total, despesas_total, limite_gastos FROM eleicoes.candidatos WHERE cargo='dep-estadual';";
const res = execSync(`"${MYSQL_BIN}" -u root --default-character-set=utf8mb4 -e "${sql}"`, { maxBuffer: 10 * 1024 * 1024 }).toString('utf8');
...
if (existsSync(arquivoTodos)) {
  ...
  console.log(`dep-estadual-todos.json atualizado com ${updated} registros.`);
}
